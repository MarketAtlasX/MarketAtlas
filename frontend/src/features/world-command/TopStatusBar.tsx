...
export default function TopStatusBar() {
  ...
  return (
    <header className="h-12 shrink-0 flex items-center justify-between px-4 border-b border-[var(--line)] bg-[rgba(4,8,12,0.8)] backdrop-blur-md relative z-20">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          <span className="h-3 w-3 rotate-45 bg-[var(--accent)] glow-accent" />
          <span className="text-sm font-semibold tracking-[0.3em] text-[var(--text-hi)]">
            MARKET<span className="text-[var(--accent)] text-glow">ATLAS</span>
          </span>
        </div>
        <span className="hidden md:inline text-[10px] uppercase tracking-[0.2em] text-[var(--text-lo)] font-mono">
          Geopolitical Intelligence
        </span>
      </div>

      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 px-2.5 py-1 rounded border border-[rgba(46,230,168,0.3)] bg-[rgba(46,230,168,0.06)]">
          <StatusDot tone="positive" />
          <span className="text-[11px] font-semibold tracking-[0.2em] text-[var(--positive)]">LIVE</span>
        </div>

        <div className="flex items-center gap-2 px-2.5 py-1 rounded border border-[var(--line)]">
